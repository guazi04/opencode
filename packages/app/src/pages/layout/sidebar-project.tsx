...
const ProjectPreviewPanel = (props: {
  ...
  projectChildren: Accessor<Map<string, Session[]>>
  workspaceSessions: (directory: string) => ReturnType<typeof sortedRootSessions>
  workspaceChildren: (directory: string) => Map<string, Session[]>
...
export const SortableProject = (props: {
  ...
  const projectChildren = createMemo(() => childMapByParent(projectStore().session, props.sortNow()))
  ...
  const workspaceChildren = (directory: string) => {
    const [data] = globalSync.child(directory, { bootstrap: false })
    return childMapByParent(data.session, props.sortNow())
  }
  const tile = () => (
    <ProjectTile
